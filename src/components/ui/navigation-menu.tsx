...
const navigationMenuTriggerStyle = cva(
  "group/navigation-menu-trigger inline-flex h-7 w-max items-center justify-center rounded-md bg-background px-3 font-medium text-sm/relaxed outline-none transition-all hover:bg-muted focus-visible:bg-muted focus-visible:outline-1 focus-visible:ring-[2px] focus-visible:ring-ring/30 disabled:pointer-events-none disabled:opacity-50 data-open:bg-muted/50 data-popup-open:bg-muted/50 data-open:focus:bg-muted data-open:hover:bg-muted data-popup-open:hover:bg-muted",
);
...
function NavigationMenuLink({
  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        "flex items-center gap-1.5 rounded-lg text-sm/relaxed outline-none transition-all hover:bg-muted focus-visible:bg-muted focus-visible:outline-1 focus-visible:ring-2 focus-visible:ring-ring/30 data-[active=true]:bg-muted/50 data-[active=true]:focus:bg-muted data-[active=true]:hover:bg-muted [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    />
