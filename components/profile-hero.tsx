      ...
      <div className="flex items-stretch border-b border-border">
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          ...
          <div className="shrink-0 border-t border-border p-0">
            <h1 className="border-b border-border px-2 text-2xl font-semibold tracking-tight leading-none sm:px-2.5 sm:text-3xl">
              {hero.name}
            </h1>
            <p className="text-muted-foreground px-2 text-sm leading-none sm:px-2.5 sm:text-base">
              {hero.role}
            </p>
          </div>
        </div>
